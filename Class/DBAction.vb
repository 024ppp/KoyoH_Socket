...
Public Class DBAction
    ...
    Public Function checkVkonName(ByVal strVkonName As String) As Boolean
        Dim strSQL As String = ""
        Dim ds As New clsDsCtrl
        ...
        Try
            ...
            For i As Integer = 0 To arrCmdText.Count - 1
                ...
                Select Case iCmd
                    ...
                    Case 1
                        If arrCmdText(i).Equals(ProcessCommand.pc.VKO.ToString) Then
                            addDelimiter(txt, iCmd)
                            txt &= arrCmdText(i) & " = '" & arrExcludeCmdText(i) & "'"
                        End If
            ...
            txt = txt.Replace(ProcessCommand.pc.VKO.ToString, "KIKNAM")
    ...
    Private Function replaceCmdText(ByVal txt As String) As String
        ...
        Try
            ...
            sBuf = txt.Replace(ProcessCommand.pc.VKO.ToString, "VKONNO")
